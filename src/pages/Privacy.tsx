    ...
    <article className="mx-auto max-w-3xl px-4 py-6 pb-16 sm:py-8">
      ...
      <header className="hero-sweep relative overflow-hidden rounded-3xl border border-border bg-card/60 p-5 sm:p-7">
        ...
        <div className="relative">
          ...
          <h1 className="display mt-2 text-4xl leading-none sm:text-5xl">Privacy Policy</h1>
      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed text-foreground/85">
        ...
        <p>
          In addition, we store the preferences you create inside Pitch26, such as favourite team,
        ...
        <p>
          ...
          do not transfer it to third parties for use in training generalized
        ...
        <p>
          Pitch26's use and transfer to any other app of information received from Google APIs
          adheres to the{" "}
          <a
        ...
        <p>
          We do not sell your data. We share limited technical data with infrastructure providers
          that are required to run the Service:
        </p>
        <ul className="list-disc pl-6">
          <li>
        ...
        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">6. Data retention</h2>
        <p>
        ...
        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">8. Security</h2>
        <p>
        ...
        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">9. Children</h2>
        <p>
          Pitch26 is not directed to children under 13, and we do not knowingly collect personal
          data from them.
        </p>
        ...
        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">11. Contact</h2>
        <p>
