...
export default function Terms() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-6 pb-16 sm:py-8">
      <Seo
      ...
      <header className="hero-sweep relative overflow-hidden rounded-3xl border border-border bg-card/60 p-5 sm:p-7">
        <div
          ...
          style={{
            background:
              "radial-gradient(60% 80% at 100% 0%, rgba(var(--primary-rgb), 0.18), transparent 60%)",
          }}
        />
        <div className="relative">
          <p className="text-[11px] uppercase tracking-[0.28em] text-primary">Legal · Pitch26</p>
          <h1 className="display mt-2 text-4xl leading-none sm:text-5xl">Terms of Service</h1>
      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed text-foreground/85">
        ...
        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">
        ...
        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">2. Eligibility</h2>
        <p>
        ...
        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">
          3. Accounts & Sign-in with Google
        </h2>
        <p>
          ...
          to your Google account, do not read your Gmail, Drive, Calendar, Contacts, or YouTube
          data, and do not access any Google Workspace content. You are responsible for maintaining
          the confidentiality of your Google account.
        </p>

        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">4. Acceptable use</h2>
        <ul className="list-disc pl-6">
          ...
          <li>
            Do not use the Service for unlawful activity or to infringe intellectual-property
            rights.
          </li>
        ...
        <p>
          Match data, news headlines, video streams, and images are provided by third parties.
          Pitch26 does not guarantee the accuracy, timeliness, legality, or availability of
          third-party content. Trademarks, team names, and competition names belong to their
        ...
        <p>
          The Pitch26 name, "PITCH26" wordmark, and app design are the property of the app owner.
          All other trademarks (including FIFA and team crests) belong to their respective owners.
        </p>

        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">7. Termination</h2>
        <p>
        ...
        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">8. Disclaimers</h2>
        <p>
        ...
        <p>
          To the maximum extent permitted by law, Pitch26 and its app owner will not be liable for
        ...
        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">11. Governing law</h2>
        <p>
          These Terms are governed by the laws applicable in the app owner's country of residence,
          without regard to conflict-of-laws principles.
        </p>

        <h2 className="mt-8 border-l-2 border-primary pl-3 display text-2xl">12. Contact</h2>
        <p>
          Questions:{" "}
