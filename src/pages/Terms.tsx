...
export default function Terms() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-16 prose prose-invert">
      ...
      <p>
        These Terms of Service ("Terms") govern your use of the Pitch26
        website and app (the "Service"), operated by the Pitch26 app owner
        ("Pitch26", "we", "us"). Pitch26 is an independent FIFA World Cup 2026
        fan hub and is not affiliated with, endorsed by, or sponsored by FIFA.
      </p>
      ...
      <p>
        Pitch26 uses Sign-In with Google to authenticate you. We request only
        the <code>openid</code>, <code>email</code>, and <code>profile</code>{" "}
        scopes. We do not post to your Google account, do not read your Gmail,
        Drive, Calendar, Contacts, or YouTube data, and do not access any
        Google Workspace content. You are responsible for maintaining the
      ...
      <ul className="list-disc pl-6">
        ...
        <li>Do not redistribute, rebroadcast, or resell live streams, video, or third-party feeds accessed through the Service.</li>
        <li>Do not use the Service for unlawful activity or to infringe intellectual-property rights.</li>
      ...
      <p>
        Match data, news headlines, video streams, and images are provided by
        third parties. Pitch26 does not guarantee the accuracy, timeliness,
        legality, or availability of third-party content. Trademarks, team
        names, and competition names belong to their respective owners and are
        used only for identification.
      </p>

      <h2 className="mt-6 text-xl font-bold">6. Intellectual property</h2>
      <p>
        The Pitch26 name, "PITCH26" wordmark, and app design are the property
        of the app owner. All other trademarks (including FIFA and team
        crests) belong to their respective owners.
      </p>

      <h2 className="mt-6 text-xl font-bold">7. Termination</h2>
      <p>
        You may stop using the Service at any time and request account
        deletion via the Privacy Policy. We may suspend or terminate access to
        the Service if you violate these Terms or if we are required to do so
        by law.
      </p>
      ...
      <p>
        To the maximum extent permitted by law, Pitch26 and its app owner will
      ...
      <p>
        ...
        to these Terms will be reflected by updating the "Last updated" date
      ...
      <p>
        These Terms are governed by the laws applicable in the app owner's
        country of residence, without regard to conflict-of-laws principles.
      </p>
